...
@WebServlet("/AdminMemberModifySummit")
public class AdminMemberModifySummit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminMemberModifySummit() {
        super();
    }
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result) {
			...
			out.println("location.href='AdminMemberModify' </script>");
